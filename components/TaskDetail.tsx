  ...
  return (
    <div style={{ padding: "24px", height: "100%", overflowY: "auto" }}>
      ...
      >
        ...
        {overdue && (
          <DetailCard icon="⚠️" label="Días de atraso" value={`${task.delay} días`} alert={true} />
        )}
        {task.wo_folio && (
          <DetailCard icon="📋" label="Folio OT" value={task.wo_folio} />
        )}
      </div>
      ...
      {task.location_description && (
        <div style={sectionStyle}>
          ...
          <div style={{ fontSize: "14px", color: "#475569" }}>{task.location_description}</div>
        </div>
      )}
      ...
      {task.requested_by && (
        <div style={sectionStyle}>
          ...
          <div style={{ fontSize: "14px", color: "#475569" }}>{task.requested_by}</div>
        </div>
      )}
    </div>
  );
